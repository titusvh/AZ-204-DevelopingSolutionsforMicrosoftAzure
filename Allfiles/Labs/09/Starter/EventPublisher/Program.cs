...
{
    private const string topicEndpoint = "https://hrtopictitusvh.eastus2-1.eventgrid.azure.net/api/events";
    ...
    private const string topicKey = "LalLLxw7L569jETCTmYr93JQ/l8Uyv5ZQTQwrwvqlFM=";
