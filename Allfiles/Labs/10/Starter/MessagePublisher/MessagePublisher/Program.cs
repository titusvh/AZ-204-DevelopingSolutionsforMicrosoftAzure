...
namespace MessagePublisher
{
    public class Program
    {
        ...
        private const string serviceBusConnectionString = "Endpoint=sb://sbnamespacetitusvh.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=kj2lB9Ztmu2CsQlfsqRB3DAMcaVt+ymiJ+ASbO08vpc=";
